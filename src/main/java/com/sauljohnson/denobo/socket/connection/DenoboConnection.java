 ...
 import com.sauljohnson.denobo.encryption.Rc4EncryptionProvider;
 ...
 import com.sauljohnson.denobo.socket.connection.state.client.InitiateGreetingState;
 import com.sauljohnson.denobo.socket.connection.state.server.TooManyPeersState;
 import com.sauljohnson.denobo.socket.connection.state.server.WaitForGreetingState;
 ...
 public class DenoboConnection {
     ...
     private DiffieHellmanKeyProvider diffieHellmanKeyProvider;
     ...
     public DenoboConnection(SocketAgent parent, Socket connection, InitialState initialState) throws IOException {
         ...
         this.observers = new CopyOnWriteArrayList<DenoboConnectionObserver>();
         ...
         diffieHellmanKeyProvider = new MayoDiffieHellmanKeyProvider();
         // Pre-generate a public/private key pair for this agent.
         privateKey = diffieHellmanKeyProvider.generatePrivateKey();
         publicKey = diffieHellmanKeyProvider.generatePublicKey(privateKey);
     ...
     public void setSharedKey(byte[] sharedKey) {
         ...
         final Rc4EncryptionProvider crypto = new Rc4EncryptionProvider(sharedKey);
