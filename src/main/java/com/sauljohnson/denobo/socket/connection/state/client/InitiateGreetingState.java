        ...
        switch(packet.getCode()) {
            ...
            case CREDENTIALS_PLZ:
                ...
                final Credentials credentials = 
                        connection.getParentAgent().getConfiguration().getCredentialsHandler()
                                .credentialsRequested(connection);
            ...
            case BEGIN_SECURE:
                ...
                connection.setSharedKey(diffieHellmanKeyProvider.generateSharedKey(remotePublicKey.toByteArray(), connection.getPrivateKey()));
            ...
            case SET_COMPRESSION:
                ...
                final CompressionProvider requiredCompressor = CompressionProviderFactory.instantiate(compressionInfo.get("name"));
            ...
            case NO:
                ...
                System.out.println("We received a NO packet: " + packet.getBody());
